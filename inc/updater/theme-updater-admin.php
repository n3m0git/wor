 ...
 * since 4.0.0
 */
function massivenews_start_load_admin_scripts() {
	...
	// Theme Setup styles
	wp_enqueue_style( 'massivenews-theme-setup', get_template_directory_uri() . '/edd-updater/theme-setup.css', false, '4.0.0' );

}
add_action( 'admin_enqueue_scripts', 'massivenews_start_load_admin_scripts' );

class P75_Theme_Updater_Admin {
	...
	function license_page() {
		...
		<div class="wrap">
			...
			<p>Your Press75 License Key is used to verify your purchase, enable automatic updates, and receive support.</p>
